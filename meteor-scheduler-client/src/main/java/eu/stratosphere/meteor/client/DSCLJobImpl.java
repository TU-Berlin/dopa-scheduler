...
import eu.stratosphere.meteor.common.*;
 ...
 * 
 */
public class DSCLJobImpl implements DSCLJob {
	 ...
	 */
	protected DSCLJobImpl(final ClientConnectionFactory connectionFac, final String clientID, final String jobID, String meteorScript){
